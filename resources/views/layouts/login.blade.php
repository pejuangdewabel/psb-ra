...
<html lang="en">
  <head>
    ...
    <title>Halaman Login | Raudhatul Athfal Al-Mushanifiyah Jakarta Timur XYZ</title>
      ...
      >
        ...
        >
          <div class="right mx-lg-0 mx-auto">
            <div
              class="align-items-center justify-content-center d-lg-none d-flex d-none d-sm-block"
            >
              <img
                class="img-fluid"
            ...
            <h3 class="title-text">Login PSB</h3>
            <p>Raudhatul Athfal Al-Mushanifiyah <br> Jakarta Timur</p>                
            <form style="margin-top: 1.5rem" action="{{ route('post-login') }}" method="post">
              @csrf
            ...
            <p class="text-center bottom-caption">
              ...
              <span class="green-bottom-caption">
                <a href="{{ route('registration') }}">Daftar</a>
              </span>
            </p>
            <p class="text-center bottom-caption">
              Kembali Ke Home
